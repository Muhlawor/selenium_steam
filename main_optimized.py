...
def main():
    ...
    for i in range(1, num_sales_to_add + 1):
        ...
        total_sum = add_to_cart(driver, i, max_price, total_sum, max_total_sum)
...
def filter_2_year_lows(driver):
    """Click the '2 year lows' filter button on the SteamDB sales page."""
...
def get_sale_price(driver, sale_index):
    """Get the sale price of the item at the given index in the SteamDB sales table."""
...
def click_sale_link(driver, sale_index):
    """Click the link of the sale item at the given index in the SteamDB sales table."""
...
def add_to_cart(driver, sale_index, max_price, total_sum, max_total_sum):
    """Add a sale item to the cart if it meets the price criteria."""
...
def handle_add_to_cart_process(driver, sale_index, total_sum):
    """Handle the process of adding a sale item to the cart."""
